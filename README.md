...
Dibuat dengan ❤️ untuk tujuan edukasi keamanan siber
...
1. Simpan file dengan nama README.md
2. Letakkan di folder yang sama dengan file haqtivist.py
3. Lihat hasilnya di:
   · GitHub/GitLab (otomatis render)
   · Text editor dengan preview markdown (VS Code, Typora)
   · Command line dengan cat README.md (tanpa efek visual)

File README ini sudah lengkap dengan:

· ✅ Banner hologram ASCII
